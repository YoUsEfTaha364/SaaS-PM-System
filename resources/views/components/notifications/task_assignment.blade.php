    ...
    <div class="flex items-start justify-between gap-4">
        ...
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500">
                    Click the button to view the task.
                </p>
       ...
       @if ($notification->data['url'] != "#")
         <a href="{{ $notification->data['url'] }}"
           class="inline-flex items-center px-4 py-2 text-sm font-medium text-white transition bg-blue-600 border border-transparent rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 whitespace-nowrap">
            View Task
        </a>
       @endif
