    ...
    <div class="max-w-4xl mx-auto p-4 sm:p-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start mb-8">
            ...
            <a href="{{ route('workspaces.index') }}"
                class="mt-4 sm:mt-0 inline-flex items-center gap-2 text-sm text-gray-600 hover:text-gray-900 transition-colors">
            ...
            <form method="POST" action="{{ route('workspaces.store') }}">
                ...
                <div>
                    ...
                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')"
                        required autofocus placeholder="e.g. My Awesome Company" />
